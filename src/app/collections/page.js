...
const collections = [
  {
    ...
    items: [
      { name: 'Royal Ring', image: '/assets/gold/gold1.jpg' },
      { name: 'Bangles Set', image: '/assets/gold/gold2.jpg' },
      { name: 'Gold Necklace', image: '/assets/gold/gold3.jpg' },
    ],
  },
  {
    ...
    items: [
      { name: 'Heart Ring', image: '/assets/diamond/diamond1.jpg' },
      { name: 'Diamond Band', image: '/assets/diamond/diamond2.jpg' },
      { name: 'Necklace Set', image: '/assets/diamond/diamond3.jpg' },
    ],
  },
  {
    ...
    items: [
      { name: 'Silver Ring', image: '/assets/silver/silver1.jpg' },
      { name: 'Oxidised Set', image: '/assets/silver/silver2.jpg' },
      { name: 'Silver Anklet', image: '/assets/silver/silver3.jpg' },
    ],
  },
]
