...
const collections = [
  {
    ...
    items: [
      { name: 'Gold Necklace', image: '/assets/gold1.JPG' },
      { name: 'Gold Necklace', image: '/assets/gold2.JPG' },
      { name: 'Gold Tops', image: '/assets/gold3.JPG' },
    ],
  },
  {
    ...
    items: [
      { name: 'Diamond Necklace', image: '/assets/diamond1.JPG' },
      { name: 'Diamond Necklace', image: '/assets/diamond2.JPG' },
      { name: 'Diamond Necklace', image: '/assets/diamond3.JPG' },
    ],
  },
  {
    ...
    items: [
      { name: 'Silver Necklace', image: '/assets/silver1.JPG' },
      { name: 'Silver Necklace', image: '/assets/silver2.JPG' },
      { name: 'Silver Necklace', image: '/assets/silver3.JPG' },
    ],
  },
]
